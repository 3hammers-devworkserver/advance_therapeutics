...
function _custom_theme_options() {
  ...
  global $google_fonts,$page_title;
  global $layers;
  /**
...
/*      array(
    ...
    //     ),
      ...
      array(
        ...
        'id'          => 'pp_logo_upload',
        'type'        => 'upload',
        'desc'        => 'For best effect logo image should be transparent png, logo from
                          live preview has 114x24px but you can use bigger, you will probably 
                          need to adjust some margins using options below ',
        'std'         => '',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
      ...
      array(
          ...
          //'desc'        => 'Desccription Recent Newsroom',
          'type'        => 'textarea',
          'section'     => 'home_text',
          'rows'        => '',
          'std'         => '',
     ...
     /* array(
      ...
      /* array(
        ...
        'choices'     => array(
                array (
                  'label'       => 'Display Title instead of Logo',
                  'value'       => '1'
                  ),
               ),
       ),
      ...
      array(
        'label'       => 'Upload Divider Image',
        'id'          => 'pp_divider_image',
        'type'        => 'upload',
        'desc'        => '',
        'std'         => get_template_directory_uri().'/images/dotted-border.png',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
        'class'       => '',
...
array(
  ...
  array(
    'label'       => 'Select column for footer',
    'id'          => 'pp_footer_widget',
    'type'        => 'select',
    //'desc'        => 'Upload favicon here (16x16)',
    'std'         => '',
...
/*array(
 ...
 array(
  ...
  'id'          => 'pp_nav_bckcolor',
  'type'        => 'colorpicker',
  'desc'        => 'Set color for Navigation Background.',
  'std'         => '#B88F3F',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  ...
  'id'          => 'pp_nav_txtcolor',
  'type'        => 'colorpicker',
  'desc'        => 'Set color for Navigation Text.',
  'std'         => '#FFFFFF',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  'label'       => 'Heading H1 Style',
  'id'          => 'pp_h1_style',
  'type'        => 'typography',
  'desc'        => 'Set style for H1 heading.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  'label'       => 'Heading H2 Style',
  'id'          => 'pp_h2_style',
  'type'        => 'typography',
  'desc'        => 'Set style for H2 heading.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  'label'       => 'Heading H3 Style',
  'id'          => 'pp_h3_style',
  'type'        => 'typography',
  'desc'        => 'Set style for H3 heading.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  'label'       => 'Heading H4 Style',
  'id'          => 'pp_h4_style',
  'type'        => 'typography',
  'desc'        => 'Set style for H4 heading.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  'label'       => 'Heading H5 Style',
  'id'          => 'pp_h5_style',
  'type'        => 'typography',
  'desc'        => 'Set style for H5 heading.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
 ...
 array(
  'label'       => 'Heading H6 Style',
  'id'          => 'pp_h6_style',
  'type'        => 'typography',
  'desc'        => 'Set style for H6 heading.',
  'std'         => '',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
...
global $page_title;
$page_title=array();
$pages = get_pages(array('post_type' => 'page','parent' => -1));

    $page_title1[] = array('value'=>'','label' => 'Select Page');
foreach($pages as $page){
    $page_title2[] = array('value'=> $page->ID,'label' => $page->post_title);
    }

$page_title = array_merge($page_title1, $page_title2);
