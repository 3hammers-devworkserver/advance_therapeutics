    ...
    class Wyde_Shortcode{
        ...
        */
        public function load_shortcodes_scripts() {
            ...
            wp_enqueue_style('flora-shortcodes', get_template_directory_uri() . '/shortcodes/css/shortcodes.css', null, '1.2.1');

            // Flora shortcodes scripts
            wp_enqueue_script('flora-shortcodes', get_template_directory_uri() . '/shortcodes/js/shortcodes.js', array('jquery'), '1.2.1', true);
        ...
        */
        public function load_editor_scripts() {
            ...
            wp_enqueue_style( 'wyde-backend-style', get_template_directory_uri() . '/shortcodes/css/backend.css', null, '1.2.1');
            
            // Flora backend scripts
            wp_enqueue_script('wyde-backend-script', get_template_directory_uri(). '/shortcodes/js/backend.js', null, '1.2.1', true);
        ...
        */
        function update_plugins(){       
            ...
            add_action( 'vc_after_mapping', array(&$this, 'update_woocommerce_shortcodes') );
            add_action( 'vc_after_mapping', array( &$this, 'update_revslider_shortcodes' ) );
            add_action( 'vc_after_mapping', array( &$this, 'update_contact_form7_shortcodes' ) );
        ...
        */
        ...
        function load_default_params(){
            ...
            $script_url = get_template_directory_uri(). '/shortcodes/js/edit-form.js';
        ...
        */
            ...
            vc_map( array(
	            ...
	            'params' => array(
                    ...
                    array(
                        ...
                        'value' => array( __( 'Allow image to auto resize to fit within the container.', 'flora' ) => 'true' )
                    ),
		            array(
			            'type' => 'dropdown',
        ...
        public function update_contact_form7_shortcodes(){
            ...
            if ( $cf7 ) {
                ...
                $contact_forms[ __( 'No contact forms found', 'flora' ) ] = 0;
            }

            vc_map( array(
                'base' => 'contact-form-7',
                'name' => __( 'Contact Form 7', 'flora' ),
                'icon' => 'icon-wpb-contactform7',
                'category' => __( 'Content', 'flora' ),
                'description' => __( 'Place Contact Form7', 'flora' ),
                'params' => array(
                    array(
                        'type' => 'dropdown',
                        'heading' => __( 'Contact Form', 'flora' ),
                        'param_name' => 'id',
                        'value' => $contact_forms,
                        'admin_label' => true,
                        'save_always' => true,
                        'description' => __( 'Select contact form from the drop down list.', 'flora' ),
                    ),
                ),
            ) );
        }
