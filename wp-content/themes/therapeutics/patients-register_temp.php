<?php 
/*
Template Name: Patients register old
*/
get_header(); ?>
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="patient-register-form">
                      ...
                      <form action="javascript:;" id="pippin_patient_form">
                        <div class="row">                        
                            <div class="col-md-4 col-sm-4">
                              <div class="form-group">
                                <label>First Name <em>*</em></label>
                                <input type="text" id="pippin_first_name" name="pippin_first_name" class="form-control">
                              </div>                              
                            </div>
                            ...
                            <div class="col-md-4 col-sm-4">
                              <div class="form-group">
                                ...
                                <input type="text" id="pippin_last_name" name="pippin_last_name" class="form-control">
                              </div>
                            </div>
                            <div class="col-md-4 col-sm-4">
                              <div class="form-group">
                                <label>Phone Number <em>*</em></label>
                                <input type="text" id="pippin_number" name="pippin_number" class="form-control">
                              </div>
                            ...
                            <div class="col-md-4 col-sm-4">
                              <div class="form-group">
                                ...
                                <input type="email" id="pippin_email" name="pippin_email" class="form-control">
                              </div>
